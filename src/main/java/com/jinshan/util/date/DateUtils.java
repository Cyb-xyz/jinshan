...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String getCurrentTime(String format) {
        SimpleDateFormat sdf = com.jinshan.util.date.DateFormatUtils.getFormat(format);
        Date date = new Date();
    ...
    public static String getCurrentTime(){
        return getCurrentTime(com.jinshan.util.date.DateFormatUtils.DATE_FORMAT2);
    }
    ...
    public static Date getCurrentDate(){
        return getCurrentDate(com.jinshan.util.date.DateFormatUtils.DATE_FORMAT2);
    }
    ...
    public static Date string2Date(String value){
        ...
        SimpleDateFormat sdf = com.jinshan.util.date.DateFormatUtils.getFormat(com.jinshan.util.date.DateFormatUtils.DATE_FORMAT2);
        Date date = null;

        try {
            value = com.jinshan.util.date.DateFormatUtils.formatDate(value, com.jinshan.util.date.DateFormatUtils.DATE_FORMAT2);
    ...
    public static Date string2Date(String value,String format){
        ...
        try {
            value = com.jinshan.util.date.DateFormatUtils.formatDate(value, format);
            date = sdf.parse(value);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static int getCurrentYear(Date value){
        String date = date2String(value, com.jinshan.util.date.DateFormatUtils.DATE_YEAR);
    ...
    public static int getCurrentYear(String value) {
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_YEAR);
        Calendar calendar = getCalendar(date, com.jinshan.util.date.DateFormatUtils.DATE_YEAR);
    ...
    public static int getCurrentMonth(Date value){
        String date = date2String(value, com.jinshan.util.date.DateFormatUtils.DATE_MONTH);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentMonth(String value) {
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_MONTH);
        Calendar calendar = getCalendar(date, com.jinshan.util.date.DateFormatUtils.DATE_MONTH);
    ...
    public static int getCurrentDay(Date value){
        String date = date2String(value, com.jinshan.util.date.DateFormatUtils.DATE_DAY);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentDay(String value){
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_DAY);
        Calendar calendar = getCalendar(date, com.jinshan.util.date.DateFormatUtils.DATE_DAY);
    ...
    public static String getCurrentWeek(Date value) {
        Calendar calendar = getCalendar(value, com.jinshan.util.date.DateFormatUtils.DATE_FORMAT1);
    ...
    public static String getCurrentWeek(String value) {
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_FORMAT1);
    ...
    public static int getCurrentHour(Date value){
        String date = date2String(value, com.jinshan.util.date.DateFormatUtils.DATE_HOUR);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentHour(String value) {
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_HOUR);
        Calendar calendar = getCalendar(date, com.jinshan.util.date.DateFormatUtils.DATE_HOUR);
    ...
    public static int getCurrentMinute(Date value){
        String date = date2String(value, com.jinshan.util.date.DateFormatUtils.DATE_MINUTE);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentMinute(String value){
        Date date = string2Date(value, com.jinshan.util.date.DateFormatUtils.DATE_MINUTE);
        Calendar calendar = getCalendar(date, com.jinshan.util.date.DateFormatUtils.DATE_MINUTE);
    ...
    public static int compareDate(String startDay,String endDay,int stype) {
        int n = 0;
        startDay = com.jinshan.util.date.DateFormatUtils.formatDate(startDay, "yyyy-MM-dd");
        endDay = com.jinshan.util.date.DateFormatUtils.formatDate(endDay, "yyyy-MM-dd");
    ...
    public static int compareTime(String startTime , String endTime , int type) {
        ...
        SimpleDateFormat sdf = com.jinshan.util.date.DateFormatUtils.getFormat("");
        int value = 0;
        try {
    ...
    public static int compare(String date1, String date2,String format) {
        DateFormat df = com.jinshan.util.date.DateFormatUtils.getFormat(format);
        try {
